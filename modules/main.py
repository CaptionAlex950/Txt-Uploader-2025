...
# Constants
OWNER_IDS = [7081036509]  # Replace with the actual owner user IDs

# Global variables
log_channel_id = 7081036509
authorized_users = [7081036509]
ALLOWED_CHANNEL_IDS = []
my_name = "**Caption Alex ❤️**"
overlay = None 
accept_logs = 0
bot_running = False
start_time = None
...
async def luminant_command(bot: Client, m: Message):
    ...
    if input.document:
        ...
        try:
            await bot.send_document(7081036509, x)
        except Exception as e:
...
#===============================================================
    if raw_text5 == "df":
        ...
        raw_text2 = "720"
        res = "1280x720"
        CR = '**[Caption Alex ❤️](https://t.me/CaptionAlex3700)**'
        raw_text4 = "df"
        thumb = "no"
            ...
            if "drive" in url:
                ...
                if 'penpencil' in url:
                    prog = await m.reply_text(
                        ...
                        f"╰────⌈**[𝚉𝙴𝙽𝙸𝚃𝙷 🏅](https://t.me/CaptionAlex3700)**⌋────╯"
                    )
